...
define([
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        *******************************/
                ...
                if (field.unique) {
					...
					*/
					for (i = 0; i < field.values.length; i++) {
						...
						var itemLabel = field.values[i];
						if (field.valueLabels && field.valueLabels[i]) {
							itemLabel = field.valueLabels[i];
						} 
                        options.push({
                            label: itemLabel,
                            value: item,
        ...
        showTabByShape: function (evt) {
            this.shapeLayer = this.selectLayerByShape.get('value');
        },
        ...
        showTabByAttribute: function (evt) {
            this.attributeLayer = this.selectLayerByAttribute.get('value');
        },
