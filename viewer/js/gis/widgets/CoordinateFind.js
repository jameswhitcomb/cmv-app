...
// not referenced
  ...
  declare, lang, array,
  on, keys,
  GraphicsLayer, Graphic, SimpleMarkerSymbol, SimpleLineSymbol, CartographicLineSymbol, PictureMarker, esriColor, webMercatorUtils, fx,
  TooltipDialog, popup,
  put, 
    ...
    // scale factor of central meridian
        ...
        flashResults: function (point) {
           ...
           //remove all graphics on the maps graphics layer
            ...
            // JW - Replace diamond symbol with crosshairs icon...
            ...
            var markerSymbolStay = new PictureMarker('/js/gis/widgets/CoordinateFind/images/crosshair_red.png', 40, 40);
            var markerSymbol = new PictureMarker('/js/gis/widgets/CoordinateFind/images/crosshair_red.png', 40, 40);
